...
assert.ok(fflateVendor, 'O descompactador ZIP deve permanecer fora do bundle inicial.');
assert.ok(famedStudyMaterials, 'Os derivados de estudo FAMED devem permanecer fora do bundle inicial.');
assert.ok(
