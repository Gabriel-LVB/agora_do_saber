export const MEMORY_CARD_POLICY_VERSION = 'agora-memory-card-policy-v1';

export const MEMORY_CARD_SELECTION_RULES = `
POLÍTICA GLOBAL DE CARTÕES DE MEMÓRIA (${MEMORY_CARD_POLICY_VERSION}):
...
- Faça a seleção dentro do próprio raciocínio e entregue somente os candidatos aprovados. O aplicativo preservará todos os cartões retornados; não conte com filtragem posterior pelo site.`;

export const DIRECT_FLASHCARD_RULES = `
...
- Revise silenciosamente a cardinalidade antes de responder. Se o back ainda contiver uma enumeração explícita ou implícita, reescreva ou rejeite o cartão; não pulverize a lista em cards fracos.`;

export const CLOZE_FLASHCARD_RULES = `
...
- O campo Extra deve explicar o mecanismo, a justificativa clínica ou o critério discriminativo que torna aquele termo correto. Não pode ser um comentário, uma paráfrase da frase ou um despejo de informações periféricas.`;
