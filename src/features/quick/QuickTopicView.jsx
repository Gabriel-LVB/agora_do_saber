                ...
                <div className="flex flex-col md:flex-row md:items-start justify-between gap-4">
                  ...
                  <div className="flex flex-wrap gap-2">
                    {isAdmin&&flashcards.length>0&&(
                      <button onClick={()=>exportFlashcardsToAnki({questions:flashcards,title:activeTopic.title,subjectTitle:QUICK_SUBJECT_TITLE,topicTitle:activeTopic.title,source:QUICK_SOURCE,hierarchy:[QUICK_SUBJECT_TITLE,activeTopic.title]})} className={`flex items-center gap-2 px-4 py-2.5 rounded-xl border text-sm font-bold ${dm?'border-yellow-700 text-yellow-400 hover:bg-yellow-900/20':'border-yellow-400 text-yellow-700 hover:bg-yellow-50'}`}>
